...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Connector.getDatabase();//创建Litepal数据库
        //addDataLitepPal();
        loadHistoryData();
    ...
    //根据edit.class返回的“num”备忘录更新数据库和备忘录列表
    ...
    private void loadAlarm(String alarm, int num, int days) {
        ...
        //广播接收器。在这里，我们使用一个显式类
        //name拥有自己的接收器（已在
        //androidmanifest.xml）实例化并调用，然后创建
        //intentsender将意图作为广播执行。
        ...
        int interval = 100 * 60 * 60 * 24 *days;
